...
//           <div>
//             <h3 className="font-bold text-lg">EcoStream</h3>
...
//               <li>Contact EcoStream</li>
//             </ul>
//           </div>

//           <div>
//             <h3 className="font-bold text-lg">EcoStream Plans</h3>
//             <ul className="mt-4 space-y-2">
//               <li>Premium Individual</li>
//               <li>Premium Duo</li>
//               <li>Premium Family</li>
//               <li>Premium Student</li>
//               <li>EcoStream Free</li>
//             </ul>
//           </div>
//         </div>
...
//           <a href="#" className="text-white hover:text-green-500"><i className="fab fa-x"></i></a>
//           <a href="#" className="text-white hover:text-green-500"><i className="fab fa-facebook"></i></a>
//         </div>
//       </div>
//     </footer>
//   );
