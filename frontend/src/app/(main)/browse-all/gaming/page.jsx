...
const Gaming = () => {
    const categories =[
        { name: 'Tabletop $ RPG', icon: 'play-circle' },
        { name: 'Fan Theories ', icon: 'newspaper' },
        { name: 'Fandom Discussions', icon: 'tv' },
        { name: 'DIY $ Crafts  ', icon: 'film' },
        { name: 'Collecting cards 4 coins ', icon: 'trophy' }
    ];
    return (
        <div className="min-h-screen bg-black text-white">
            {/* Gaming Section */}
            <h2 className="text-2xl font-bold mb-4">Gaming $ Hobbies</h2>
