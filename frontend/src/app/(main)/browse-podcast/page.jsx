...
//       // Reset edit state
//       setEditPodcast(null);
//       setFormData({ title: "", description: "", audioUrl: "", duration: "", tags: "" ,category:"",language:"",transcript:"",coverImageUrl:"" });
...
export default function BrowsePodcasts() {
  ...
  const handleSave = async () => {
    try {
      ...
      setEditPodcast(null);
      setFormData({
        title: "", description: "", audioUrl: "", duration: "", tags: "",
        category: "", language: "", transcript: "", coverImageUrl: ""
      });
              ...
              <div key={podcast._id} className="bg-gradient-to-br from-gray-800 to-purple-900 rounded-lg overflow-hidden shadow-lg hover:shadow-purple-900/30 transition group">
                {editPodcast === podcast._id ? (
                  <div className="p-5">
                    ...
                    <div className="space-y-3">
                      {["title", "description", "audioUrl", "duration", "tags"].map((field) => (
                        <div key={field}>
